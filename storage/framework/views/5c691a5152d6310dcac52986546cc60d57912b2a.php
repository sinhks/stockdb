                ...
                <div class="sidebar pt-3">
                    ...
                    <nav class="mt-2">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('shopping.create')); ?>" class="nav-link text-white">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Shopping Card
                                </p>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview sub-menu">
                                    ...
                                    <li class="nav-item"><a href="<?php echo e(route('suppliers.index')); ?>" class=" nav-link  <?php echo e(Request::routeIs('suppliers.index') ? 'active' : ''); ?> "><i class="far fa-circle nav-icon"></i> Supplier</a></li>
                                    
                                    <li class="nav-item"><a href="" class="nav-link"><i class="far fa-circle nav-icon"></i> Exchange rate</a></li>
                                    <li class="nav-item"><a href="<?php echo e(route('categories.index')); ?>" class=" nav-link  <?php echo e(Request::routeIs('categories.index') ? 'active' : ''); ?> "><i class="far fa-circle nav-icon"></i> Category</a></li>
